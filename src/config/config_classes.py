...
def create_config(config_dict: dict) -> Config:
    return Config(
        ...
        transform_conf=TransformConf(
            transform_input=TransformerConf(
                transform_data=config_dict['transform_conf']['transform_input']['transform_data'],
                transformer_class=config_dict['transform_conf']['transform_input']['transformer_class'],
                transformer_options=config_dict['transform_conf']['transform_input']['transformer_options'],
                columns=config_dict['transform_conf']['transform_input']['columns']
            ),
            transform_output=TransformerConf(
                transform_data=config_dict['transform_conf']['transform_output']['transform_data'],
                transformer_class=config_dict['transform_conf']['transform_output']['transformer_class'],
                transformer_options=config_dict['transform_conf']['transform_output']['transformer_options'],
