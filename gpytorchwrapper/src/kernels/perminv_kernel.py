...
class PermInvKernel(Kernel):
    ...
    ------
    NotImplementedError
        If the `ard_num_dims` keyword is used instead of `ard`.
    ValueError
        If the expected number of unique distances does not match the amount generated by the ARD expansion.
    """
    ...
    def __init__(
        ...
        n_atoms: int,
        idx_equiv_atoms: list[list[int]],
        select_dims: Optional[list[int]] = None,
        ard: bool = False,
        **kwargs,
    ):
